...
export class HomePage implements OnInit {
  recipes: Recipe[] = [
    ...
    { id: 4, name: 'Hearty Lentil Soup', description: "Warm up with a bowl of this wholesome and satisfying lentil soup. Packed with nutritious lentils, vegetables, and aromatic spices, it's a perfect meal for a chilly day.", bannerImg: '', ingredients: [], steps: [], author: '../../../assets/images/hearty_lentil_soup.png', isFork: false, parentRecipe: 0, numLikes: 0, numSaved: 0},
